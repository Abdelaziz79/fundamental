...
export const CustomNode: React.FC<{ data: { label: string } }> = ({ data }) => {
  return (
    <div className="overflow-hidden my-1 bg-green-200 border-green-400 border-2 text-gray-700 rounded-full w-14 h-14 font-semibold flex items-center justify-center">
